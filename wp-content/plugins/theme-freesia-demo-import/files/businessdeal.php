...
function businessdeal_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/businessdeal/businessdeal.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/businessdeal/businessdeal-widgets.wie',
    ...
    array(
      ...
      'isPlus'                      => true,
      'buy_url'                    => 'https://themefreesia.com/plugins/businessdeal-plus/'
    ),
  );
}
...
function businessdeal_after_import_setup() {
    ...
    $social_links = get_term_by( 'name','Social Links Menu', 'nav_menu' );
