...
class ViewHelpers {
	...
	public static function plugin_header_output() {
		...
		<div class="ocdi__title-container">
			<h1 class="ocdi__title-container-title"><?php esc_html_e( 'Theme Freesia Demo Import', 'theme-freesia-demo-import' ); ?></h1>
		</div>
		<?php
	...
	public static function small_theme_card( $selected = null ) {
		...
		<div class="ocdi__card ocdi__card--theme">
			<div class="ocdi__card-content">
				<?php if ( $screenshot ) : ?>
					<div class="screenshot"><img src="<?php echo esc_url( $screenshot ); ?>" alt="<?php esc_attr_e( 'Theme screenshot', 'theme-freesia-demo-import' ); ?>" /></div>
				<?php else : ?>
