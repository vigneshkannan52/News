...
get_header();
	global $zon_settings;
	$zon_settings = wp_parse_args(  get_option( 'zon_theme_options', array() ),  zon_get_option_defaults_values() );
...
<div class="wrap">
	<div id="primary" class="content-area">
		...
		<div class="googlemaps_widget">
			<div class="maps-container">
				<?php if ( is_active_sidebar( 'zon_form_for_contact_page' ) ) :
				dynamic_sidebar( 'zon_form_for_contact_page' );
			endif;  ?>
			</div>
		...
		<?php endif; ?>
			...
			<h2 class="entry-title"> <?php esc_html_e( 'No Posts Found.', 'zon' ); ?> </h2>
			<?php
			} ?>
	...
	<aside id="secondary" class="widget-area" role="complementary" aria-label="<?php esc_attr_e('Side Sidebar','zon');?>">
		...
		if ( is_active_sidebar( 'zon_contact_page_sidebar' ) ) :
			dynamic_sidebar( 'zon_contact_page_sidebar' );
		endif;?>
		<?php 
		if( 'default' == $layout ) { //Settings from customizer
			if(($zon_settings['zon_sidebar_layout_options'] != 'nosidebar') && ($zon_settings['zon_sidebar_layout_options'] != 'fullwidth')): ?>
