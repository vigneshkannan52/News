...
class Zon_category_box_two_column_Widgets extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget-cat-box-2', 'description' => __( 'Display Category box two layout widget', 'zon') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=__('TF: Category Box Two Layout Widget','zon'), $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		$category2 = absint($instance[ 'category2' ]);
		...
		<p>
			...
			<input type="radio" <?php checked($box_layout, 'box-two-layout-1') ?> id="<?php echo $this->get_field_id( 'box_layout' ); ?>" name="<?php echo $this->get_field_name( 'box_layout' ); ?>" value="box-two-layout-1"/><?php _e( 'Box Layout 1', 'zon' );?> &nbsp; &nbsp; &nbsp;
			<input type="radio" <?php checked($box_layout, 'box-two-layout-2') ?> id="<?php echo $this->get_field_id( 'box_layout' ); ?>" name="<?php echo $this->get_field_name( 'box_layout' ); ?>" value="box-two-layout-2"/><?php _e( 'Box Layout 2', 'zon' );?><br>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('link2');?>">
				<?php _e('Custom Link 2:', 'zon');?>
			</label>
			<input id="<?php echo $this->get_field_id('link2');?>" name="<?php echo $this->get_field_name('link2');?>" type="text" value="<?php echo esc_url($link2);?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'category2' ); ?>"><?php _e( 'Select category', 'zon' ); ?>:</label>
			<?php wp_dropdown_categories( array( 'show_option_none' =>' ','name' => $this->get_field_name( 'category2' ), 'selected' => $category2 ) ); ?>
		</p>
		<?php
	}
					...
					<div class="widget widget-cat-box-right">
						...
						if ( $title2!='' || $link2!='' ){ ?>
							<h2 class="widget-title">
								...
								<a href="<?php echo esc_url($link2);?>" class="more-btn"><?php echo esc_html($zon_tag_text); ?></a>
								<?php } ?>
							</h2>
						<?php	}
